    ...
    <div className="min-h-screen flex flex-col justify-between" style={{ backgroundColor: 'rgb(75 141 216 / 29%)' }}>
      ...
      <main className="flex flex-col lg:flex-row max-w-7xl mx-auto py-16 px-4 lg:space-x-16">
        ...
        <section className="flex-1 bg-white p-8 border-b lg:border-r lg:border-b-0 lg:border-gray-300">
          ...
          <button className="mt-6 bg-bright-blue text-white px-4 py-2 rounded-md font-medium" onClick={() => navigate("/faculty/login")}>
            Login
          </button>
          <p className="mt-4 text-sm text-gray-600">
            Don’t have an account? <Link to="/faculty/register" className="text-bright-blue hover:underline">Sign up</Link>.
          </p>
        </section>
        ...
        <section className="flex-1 bg-white p-8 border-t lg:border-t-0 lg:border-l lg:border-gray-300">
          ...
          <button className="mt-6 bg-gray-800 text-white px-4 py-2 rounded-md font-medium" onClick={() => navigate("/student/login")}>
            Login
          </button>
          <p className="mt-4 text-sm text-gray-600">
            Don’t have an account? <Link to="/student/register" className="text-bright-blue hover:underline">Sign up</Link>.
          </p>
        </section>
      </main>
